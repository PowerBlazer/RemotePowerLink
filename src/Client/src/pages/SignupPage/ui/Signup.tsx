...
export default function Signup () {
    ...
    const { step, setStepRegistration } = useContext(RegistrationContext);

    const backStepHandler = () => {
        if(step === RegistrationSteps.ConfirmEmail){
            setStepRegistration(RegistrationSteps.SendEmailVerification);
        }
        
        if(step === RegistrationSteps.Registration){
